...
public class RecyclerViewBridge extends EffectNoDrawBridge {
    ...
    public void flyWhiteBorder(final View focusView, View moveView, float scaleX, float scaleY) {
        ...
        ObjectAnimator scaleXAnimator = ObjectAnimator.ofInt(new ScaleView(moveView), "width", oldWidth,newWidth);
        ObjectAnimator scaleYAnimator = ObjectAnimator.ofInt(new ScaleView(moveView), "height", oldHeight,newHeight);
