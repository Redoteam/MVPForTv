 ...
 */
package com.redoteam.core.http.imageloader.glide;
...
import com.redoteam.core.http.OkHttpUrlLoader;
...
//        final AppComponent appComponent = ArmsUtils.obtainAppComponentFromContext(context);
        ...
        builder.setDiskCache(new DiskCache.Factory() {
            ...
            public DiskCache build() {
                ...
                return DiskLruCacheWrapper.create(DataHelper.makeDirs(new File(appDelegate.getmGlobalConfigModule().provideCacheFile(appDelegate.getmApplication()), "Glide")), IMAGE_DISK_CACHE_MAX_SIZE);
            }
        });
        ...
        BaseImageLoaderStrategy loadImgStrategy = appDelegate.getmGlobalConfigModule().provideImageLoaderStrategy();
...
//        AppComponent appComponent = ArmsUtils.obtainAppComponentFromContext(context);
        ...
        registry.replace(GlideUrl.class, InputStream.class, new OkHttpUrlLoader.Factory(apiEngine.getOkHttpClient()));
    }
